    ...
    return (
      <div className="App">
        ...
        <Card body className="message-form">
          <CardTitle>Welcome to Guset Map!</CardTitle>
          <CardText>Leave message and your location.</CardText>
          ...
          <Form onSubmit={this.formSubmitted}>
            ...
            <Button color="info" disabled={!this.state.haveUserLocation}>Send</Button>
          </Form>  
        </Card>
      </div>
    );
